...
namespace library
{
    /*C+C+++C+++C+++C+++C+++C+++C+++C+++C+++C+++C+++C+++C+++C+++C+++C+++C
      ...
      Methods:  WindowProc
                ...
                GetWindowClassName
                    ...
                    the window class
                HandleMessage
                    Purely virtual function that handles the
                    messages
                GetWindow
    ...
    template <class DerivedType>
    LRESULT CALLBACK library::BaseWindow<DerivedType>::WindowProc(_In_ HWND hWnd, 
    ...
    template <class DerivedType>
    library::BaseWindow<DerivedType>::BaseWindow() :
    ...
    template <class DerivedType>
    HWND library::BaseWindow<DerivedType>::GetWindow() const {
        return m_hWnd;
    }
    ...
    template <class DerivedType>
    HRESULT library::BaseWindow<DerivedType>::initialize(
        _In_ HINSTANCE hInstance,
        _In_ INT nCmdShow,
        _In_ PCWSTR pszWindowName,
        _In_ DWORD dwStyle,
        ...
        m_hWnd = CreateWindowEx(dwExStyle, GetWindowClassName(), pszWindowName, dwStyle, x, y, nWidth, 
